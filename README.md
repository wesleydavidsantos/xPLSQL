...
- ✅ **Easy to install**: Ready-to-use scripts for any Oracle environment.
- ✅ **TDD support**: Create tests before or during development.
- ✅ **Integrated reporting**: Compatible with SQL Developer for viewing results.
- ✅ **Extensible**: Add custom assertions and functionalities as needed.

---

## 📦 Project Structure

- `instalador_wds_plsql_tdd/`: Framework installation scripts.
- `exemplos/`: Sample test cases for reference.
- `relatorios_SqlDeveloper/`: Report templates for use with SQL Developer.
- `README_ptBR.md`: Documentation in Portuguese.
...
xPL/SQL is an automated testing system developed in PL/SQL, designed to simplify and expedite the process of creating unit tests in the PL/SQL language.
...
There is a significant difference between an adapted system and a dedicated one, and xPL/SQL is dedicated to the PL/SQL language.

Unlike other solutions that involve the use of additional programming languages, such as jUnit which uses Java, xPL/SQL allows PL/SQL developers to create tests directly, eliminating the need to learn a new language and significantly reducing the learning curve.
...
Often, PL/SQL developers and teams encounter the need to create unit tests for their Procedures, Functions, and Packages. However, most available solutions involve the use of additional programming languages, which can be complex and time-consuming. xPL/SQL aims to address this issue by allowing tests to be written directly in PL/SQL, simplifying and streamlining the process.
...
Here are the steps to get started using xPL/SQL in your project:

## Installation - User Creation

1. Download the xPL/SQL system scripts.

2. To install and use the xPL/SQL system, you need to create two users.
...
Note: The xPL/SQL system was developed using the "Oracle Database 19c Release 19.0.0.0.0" version. If you encounter any issues with earlier versions, please contact us.
...
[![xPL/SQL - Test Examples](https://img.youtube.com/vi/Ozswl1GJFdE/0.jpg)](https://www.youtube.com/watch?v=Ozswl1GJFdE "xPL/SQL - Test Examples")
